...
class ZKLibrary {
	...
	public function getAttendance()
	{
		if ($this->protocol == 'TCP') {
            ...
            $size = 0;
	        if ($comando == CMD_ACK_OK) {
	            $u = unpack('H2h1/H2h2/H2h3/H2h4/H2h5/H2h6/H2h7/H2h8', substr($this->received_data, 17, 8));
	            $size = hexdec($u['h4'] . $u['h3'] . $u['h2'] . $u['h1']);
	        } else {
	        	if (substr($this->received_data, 16, 8)){
                    $u = unpack('H2h1/H2h2/H2h3/H2h4/H2h5/H2h6/H2h7/H2h8', substr($this->received_data, 16, 8));
                    $size = hexdec($u['h4'] . $u['h3'] . $u['h2'] . $u['h1']);
				}
